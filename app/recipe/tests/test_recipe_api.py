...
def create_recipe(user, **params):
    ...
    defaults = {
        'title': 'Sample recipe title', 'time_minutes': 22,
        'price': Decimal('5.25'), 'description': 'Sample description',
...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_recipe(self):
        ...
        payload = {
            'title': 'Sample recipe', 'time_minutes': 30,
            'price': Decimal('5.99')
        }
    ...
    def test_full_update(self):
        ...
        payload = {
            'title': 'New recipe title', 'time_minutes': 10,
            'link': 'http://example.com/new_recipe.pdf',
            'description': 'New recipe description.', 'price': Decimal('2.50')
        }
    ...
    def test_create_recipe_with_new_tags(self):
        ...
        payload = {
            'title': 'Thai Prawn Curry', 'time_minutes': 30,
            'price': Decimal('2.50'),
        ...
        for tag in payload['tags']:
            self.assertTrue(
                Tag.objects.filter(name=tag['name'], user=self.user).exists()
            )
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        payload = {
            'title': 'Cauliflower Tacos', 'time_minutes': 60,
            'price': Decimal('4.30'),
    ...
    def test_create_recipe_with_existing_ingredient(self):
        ...
        payload = {
            'title': 'Vietnamese Soup', 'time_minutes': 25,
            'price': '2.55',
    ...
    def test_filter_by_tags(self):
        ...
        r2 = create_recipe(user=self.user, title='Aubergin Tahini')
